                  ...
                  <tr>
                    ...
                    while($row = mysql_fetch_array($sql)){
                      ...
                      while($sub_row = mysql_fetch_array($sub_sql)){
                        ...
                        while($con_row = mysql_fetch_array($content)){
                          $am_accountcode = $con_row['am_accountcode'];
                          $sum_bf = mysql_query("SELECT SUM(c_primeamt)AS sumbf FROM am_balance WHERE c_accountcode='$am_accountcode' AND c_date <'$from_date'") or die(mysql_error());
                          $sum_bf_row = mysql_fetch_array($sum_bf);
                          $sumbf = $sum_bf_row['sumbf'];
                          $sumbfC = '';
                          $sumbfD = '';
                          ...
                          $sum_cdr = mysql_query("SELECT SUM(c_primeamt)AS sumcdr FROM am_balance WHERE c_accountcode='$am_accountcode' AND c_date BETWEEN '$from_date' and '$to_date'") or die(mysql_error());
                          $sum_cdr_row = mysql_fetch_array($sum_cdr);
                          $sumcdr = $sum_cdr_row['sumcdr'];
                          $sumcdrC = '';
                          $sumcdrD = '';
                          ...
                          $sum_cf = mysql_query("SELECT SUM(c_primeamt)AS sumcf FROM am_balance WHERE c_accountcode='$am_accountcode' AND c_date BETWEEN '$from_date' and '$to_date'") or die(mysql_error());
                          $sum_cf_row = mysql_fetch_array($sum_cf);
                          $sumcf = $sum_cf_row['sumcf'];
                          $sumcfC = '';
                          $sumcfD = '';
