...
<html lang="en">
  <head>
    ...
    <title>Adjustment Issue Voucher</title>
  	...
  	<div class="container">
  		<div class="row">
              ...
              ?>
                ...
                <div class="col-md-6">
                  <h2 style="border-bottom:1px solid #CCC"><b>Adjustment Issue Voucher</b></h2>
                </div>
  						</div>
              <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-borderless2">
                      ...
                      <tr>
                        ...
                        <td><?php echo $ro['am_status']?></td>
  						...
  						<div class="table-responsive">
                <form method="post" action="excel/advoucher.php?pVoucherNo=<?php echo $pVoucherNo?>" >
