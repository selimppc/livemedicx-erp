  	...
  	<div class="container">
  		<div class="row">
              ...
              ?>
  						...
  						<div class="row">
                <div class="col-md-12">
                  <h2 style="border-bottom:2px solid #000" class="col-md-5"><b>Receipt Voucher</b></h2>
                </div>
  						</div>
              <div class="row">
              <div class="col-md-12">
  						<div>
                <form method="post" action="excel/receipt_voucher.php?pVoucherNo=<?php echo $pVoucherNo?>">
  							<?php
