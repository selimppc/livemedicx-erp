...
if(isset($_POST["pdf"])){
  ...
  //$pdf->Cell(80);
  $pdf->Cell(0,10,'Receipt Voucher',0,0,'L');
  //$pdf->Ln(10);
  ...
  if(mysql_num_rows($sql) > 0)  
    {  
      ...
      <table class="table">  
        <tr>  
          <th colspan="8" align="left"><h2><u>Receipt Voucher</u></h2></th>    
        </tr> 
        <tr>  
    ...
    header("Content-Disposition: attachment; filename=Recipt_Voucher.xls");  
    echo $output;  
