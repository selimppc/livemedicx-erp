  		...
  		<div class="row">
              ...
              <?php
                function url_origin( $s,$use_forwarded_host = false){
                  ...
                  $protocol = substr( $sp, 1, strpos($sp, '/')).(($ssl)?'s':'');
                  $port = $s['SERVER_PORT'];
              ...
              ?>
  						...
  						<div class="row">
                <div class="col-md-12">
                  <h2 style="border-bottom:2px solid #000" class="col-md-5"><b>Journal Voucher</b></h2>
                </div>
  						</div>
              <div class="row">
              <div class="col-md-12">
  						<div>
                <form method="post" action="excel/journal_voucher.php?pVoucherNo=<?php echo $pVoucherNo?>">
  							<?php
              ...
              <table  class="table table-borderless2">
                <tr>
                  <th width="665px" class="text-right">Total Local Report Summary</th>
                  <th class="text-left"style="border-top:1px solid #000">'.number_format($debetl_sum_row['dabetl_sum'],2).'</th>
                  <th class="text-left" style="border-top:1px solid #000">'.number_format($creditl_sum_row['creditl_sum'],2).'</th>
                </tr>
              </table>
              ';
                ?>
