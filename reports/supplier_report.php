  	...
  	<div class="container">
  		<div class="row">
              ...
              <?php
               ...
               //print_r($f_word); //branch
               // echo $second_word;// supplier
              ?>
                ...
                <form action="excel/supplier_report.php?f_word=<?php echo $f_word?>&second_word=<?php echo $second_word?>&from_date=<?php echo $from_date?>&to_date=<?php echo $to_date?>" method="post">
                  ...
                  <h4 class="text-left"><b>Branch: <?php echo $f_word ?></b></h4>
                </div>
                <?php
                $ssql = '';
                if($f_word == true && $second_word == true){
                  $ssql = mysql_query("SELECT * FROM `cm_suppliermaster` WHERE cm_supplierid='$second_word'");
                }
                
                else if ($f_word == false && $second_word == true) {
                 header('Location:supplier_ledger_all.php?from_date='.$from_date.'&to_date='.$to_date.'&sup='.$second_word);
                }
                 else if ($f_word == false && $second_word == false) {
                 header('Location:supplier_ledger_all_1.php?from_date='.$from_date.'&to_date='.$to_date);
                }
                else if ($f_word == true && $second_word == false) {
                 header('Location:supplier_ledger_all_2.php?from_date='.$from_date.'&to_date='.$to_date.'&b_word='.$f_word);
                }
