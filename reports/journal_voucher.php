  	...
  	<div class="container">
  		<div class="row">
              ...
              ?>
  						...
  						<div class="row">
                <div class="col-md-12">
                  <h2 style="border-bottom:2px solid #000" class="col-md-5"><b>Journal Transaction</b></h2>
                </div>
  						</div>
              <div class="row">
              <div class="col-md-12">
                ...
                print'<table  class="table table-borderless2">
                  ...
                  mysql_query("INSERT INTO `jurnal_sum` VALUES('','$Dabets','$fCredits','$Dabetls','$fCreditls')") or die(mysql_error());
                  print'
                    <tr>
                      <td colspan="4"></td>
