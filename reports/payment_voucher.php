  	...
  	<div class="container">
  		<div class="row">
              ...
              ?>
  						...
  						<div class="row">
                <div class="col-md-12">
                  <h2 style="border-bottom:2px solid #000" class="col-md-5"><b>Payment Voucher</b></h2>
                </div>
  						</div>
              <div class="row">
              <div class="col-md-12">
  						<div>
                <form method="post" action="excel/payment_voucher.php?pVoucherNo=<?php echo $pVoucherNo?>">
  							<?php
              ...
              print'
                ...
                <th colspan="6" class="text-right">Total Local Report Summary</th>
                  <th>'.number_format($debetl_sum_row['dabetl_sum'],2).'</th>
                  <th>'.number_format($creditl_sum_row['creditl_sum'],2).'</th>
                </tr>
              </tbody>
                </table>
              ';
