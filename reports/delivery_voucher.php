  	...
  	<div class="container">
	    ...
	    /*  $sql1 = mysql_query("SELECT * FROM `sm_header` INNER JOIN cm_customermst on sm_header.cm_cuscode=cm_customermst.cm_cuscode WHERE sm_header.glvoucher='$pVoucherNo'") or die(mysql_error());
              ...
              ?>
                ...
                <div class="col-md-6">
                  <h2 style="border-bottom:1px solid #CCC"><b>COGS Voucher</b></h2>
                </div>
  						</div>
              <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-borderless2">
                      ...
                      <tr>
                        ...
                        <td><?php echo $ro['am_status']?></td>
  						...
  						<div class="table-responsive">
                <form method="post" action="excel/delivery_vouche.php?pVoucherNo=<?php echo $pVoucherNo?>" >
                ...
                <table  class="table table-bordered">
                  ...
                  while($row= mysql_fetch_array($sq)){
                    ...
                    $dabet = $row['c_primeamt'];
                    if($dabet<0){
                      $dabet = '';
                    }
                    $credit = $row['c_primeamt'];
                    //echo $credit;
                    if($credit > 0){
                      $credit = '';
                    }else{
                  ...
                  <tr>
                    ...
                    <th>'.number_format($tdabet_row['dabet_total'],2).'</th>
                    <th>'.number_format($tcredit_row['credit_total'],2).'</th>
                  </tr>
                  ';
                  mysql_query("DELETE FROM `temp`")or die(mysql_error());
                  mysql_query("DELETE FROM `tab_ldc2`")or die(mysql_error());
                  ?>
