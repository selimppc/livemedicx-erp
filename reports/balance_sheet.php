        ...
        <div class="col-md-12">
          <div class="portlet">
            <div class="portlet-content">
              ...
              <div class="row">
                <div class="col-md-12">
                  <h2 class="text-center"><b>Balance Sheet<br>As at<br><?php echo $word_two?>, <?php echo $word_one?></b></h2>
                </div>
              </div>
              <div class="row">
              <div class="col-md-12">
              <h3 style="border-bottom:1px solid #CCC">For Branch: <?php echo $word_three?></h3>
                <form method="post" action="excel/balance_sheet.php?word_one=<?php echo $word_one?>&word_two=<?php echo $word_two?>&word_three=<?php echo $word_three?>&word_four=<?php echo $word_four?>" >
                  ...
                  <table class="table table-bordered table-highlight" data-provide="datatable" data-info="false" data-search="false" data-display-rows="15" data-length-change="false" data-paginate="true">
                    ...
                    if($word_four=='Summary'){
                      ...
                      while($sub_row = mysql_fetch_array($subsql)){
                        ...
                        print'
                        <tr>
                          <th>'.$am_grouptwo.'-'.$am_description.'</th>
                          <th class="text-right">'.number_format($head_row['base'],2).'</th>
                          <th class="text-right">'.number_format($head_row2['prime'],2).'</th>
                        <tr>
                        ';
                      }
                      ...
                      if($group==1){
                        ...
                        print'
                      <tr>
                        <th class="text-right">Total '.$head_name.'</th>
                      ...
                      print'
                    <tr>
                      <th>Add: Profit / Loss During The Period</th>
                      ...
                      while($sub_row = mysql_fetch_array($subsql)){
                        ...
                        while($car_acc_row = mysql_fetch_array($car_acc)){
                          ...
                          if($t_b_a && $t_p_a=='0.00'){
                            ...
                            print'
                          <tr>
                            <td>'.$car_acc_row['am_accountcode'].'&nbsp;'.$car_acc_row['am_description'].'</td>
