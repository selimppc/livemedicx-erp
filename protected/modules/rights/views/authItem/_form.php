...
<?php $form=$this->beginWidget('CActiveForm'); ?>
	...
	<div class="row buttons">
		...
		<?php echo CHtml::submitButton(Rights::t('core', 'Save'), array('class'=>'action-btn', 'id'=>'action-btn-1')); ?> &nbsp; <span style="line-height:48px;">
        <?php echo CHtml::link(Rights::t('core', 'Cancel'), Yii::app()->user->rightsReturnUrl, array('class'=>'action-btn-cancel', 'id'=>'action-btn-2'));  ?> 
		</span>
                </div>
            </div>
	</div>
