...
$this->menu=array(
    ...
    array('label'=>UserModule::t('Change password'), 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/settings_a12.png" /></span>{menu}', 'url'=>array('changepassword')),
...
<br>
<h4><?php if(Yii::app()->user->hasFlash('profileMessage')): ?></h4>
<div class="success">
	<h4><?php echo Yii::app()->user->getFlash('profileMessage'); ?></h4>
</div>
