		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('admin', 'delete', 'create', 'update', 'Inventory', 'ItemLedger', 'LedReport', 'PurchaseOrder','PurchaseOrders', 'GLReports', 'TrialBalanceReport', 'TrialBlance', 'TrialBlanceAll', 'TrialBalanceAllReport',
                    ...
                    'DeliveryOrderChallan', 'DeliveryOrderChallans', 'ProductList', 'ProductListReports','EproductList','branchlistreport',
                    'CustomerLedger', 'CustomerLedgerReport','CustomerLedgerSales', 'CustomerLedgerSalesReport','CustomerListReport','SupplierReport','SupplierReport_AP','SupplierLedgerReport',
                    ...
                    'LedgerAcGlReports','SummaryStockReport','salesReport','salesReport','SupplierLedger_AP'
                ),
				'users'=>array('@'),
			),
...
//apel
    public function actionEproductList(){
		$model = new Productmaster;
		
		$this->render('eproduct_list', array(
			'model'=>$model,
		));
	}
     ...
     public function actionSupplierReport(){
		...
		$this->render('supplier_report', array(
			'model'=>$model,
		));
	}
	 ...
	 public function actionSupplierReport_AP(){
		$model = new Branchmaster;
		
		$this->render('supplier_report_ap', array(
			'model'=>$model,
		));
	}
	public function actionSupplierLedger_AP(){
		$model = new Branchmaster;
		
		$this->render('supplier_ledger_ap', array(
			'model'=>$model,
		));
	}
	...
	public function actionBranchlistreport(){
		$model = new Branchmaster;
		
		$this->render('branch_list_report', array(
			'model'=>$model,
		));
	}
	public function actionCustomerListReport(){
		$model = new Customermst;
		
		$this->render('customer_list_report', array(
			'model'=>$model,
		));
	}
    //apel
...
public function actionSummaryStockReport(){
        $this->pageTitle = 'Summary Stock Balance';

        $model = new Customermst;

        $this->render('summary_stock_report', array(
            'model'=>$model,
        ));
    }
    /*
