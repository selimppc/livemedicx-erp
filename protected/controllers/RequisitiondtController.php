	...
	protected function performAjaxValidation($model)
	{
		...
		public function actionAcomplete(){
			...
			if (!empty($_GET['term'])) {
				...
				$sql = 'SELECT cm_code as value, cm_name as label, cm_purunit as unit, ROUND(cm_purconfact) as unitquantity FROM cm_productmaster WHERE cm_name LIKE :qterm OR cm_code LIKE :qterm';
