...
class GrouponeController extends Controller
{
		        	...
		        	if(isset($_POST['Groupone']))
						{
							...
							if($model->save()){
                                Yii::app()->user->setFlash('success', Yii::t('group', 'Success Message : Data Created Successfully !'));
                            }else{
                                Yii::app()->user->setFlash('error', Yii::t('group', 'Warning Message: Group One Code Already Exists !'));
                            }
	...
	public function actionDelete($id)
	{
        ...
        try{
            ...
            if(!isset($_GET['ajax']))
                Yii::app()->user->setFlash('error',' Warning Message: Delete Accounts details, before deleting Accounts header !');
            else
                echo "<div class='flash-error'>  Warning Message: Delete Accounts details, before deleting Accounts header ! </div>";
        }
