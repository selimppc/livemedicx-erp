...
class BranchmasterController extends Controller
{
	...
	public function actionUpdate($cm_branch)
	{
		...
		if(isset($_POST['Branchmaster']))
		{
			...
			if($model->save()){
				...
				$this->redirect(array('view','cm_branch'=>$model->cm_branch));
		}

		$this->render('update',array(
			'model'=>$model,'cm_branch'=>$cm_branch,
		));
	}
	 ...
	 */
	public function loadModel($cm_branch)
	{
		$model=Branchmaster::model()->findByPk($cm_branch);
		if($model===null)
