...
<div style="width: 99%; float: left;">
     <div style="width: 46%; float: left; margin-right: 3%;">
         <h1 style="text-align: center; font-weight: bold; background: #BA7F39; padding: 7px; width: 95%; text-align: center;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <h1 style="text-align: center; font-weight: bold; background: #BA7F39; padding: 8px; width: 95%; text-align: center;">
