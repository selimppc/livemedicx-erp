...
<table style="width: 99%; float: left;">
	...
	<tr>
		<td style="text-align: center; background: white; color: black;">Account Code <span class="required">*</span></td>
	...
	<tr>	
		<td style="text-align: center; background: white; color: black;"> Description <span class="required">*</span></td>
	...
	<tr>
		<td style="text-align: center; background: white; color: black;"> Account Type </td>
	...
	<tr>
		<td style="text-align: center; background: white; color: black;">Account Usage </td>
	...
	<tr>
		<td style="text-align: center; background: white; color: black;">First Group </td>
		<td> <?php 
	...
	<tr>
		<td style="text-align: center; background: white; color: black;">Second Group </td>
	...
	<tr>
		<td style="text-align: center; background: white; color: black;"> Analytic Type </td>
		<td> <?php echo $form->dropDownList($model,'am_analyticalcode',array(
                'Cash'=>'Cash','Non-Cash'=>'Non-Cash')); ?>
        </td>
	</tr>
	<tr>	
		<td style="text-align: center; background: white; color: black;"> Status </td>
		<td class="compactRadioGroup"> 
