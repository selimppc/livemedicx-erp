...
<div style="width: 98%; float: left;" >
    ...
    <div style="width: 48%; float: left;" >
        <div class="form">
            ...
            <table>
                ...
                <tr>
                    <td style="text-align: center; background: white; color: black;"> <b>Category</b> </td>
                    <td>
    ...
    <div style="width: 52%; float: left; line-height: 14px;" >
        ...
        <h1 style="background: #BA7F39; padding: 7px; width: 97%; font-weight: bold; border-radius: 10px; text-align: center;">
            IM to GL
        </h1>
