...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        <b>Manage Receipt Voucher</b>: This screen will allow you to view the overall Receipt Voucher’s detail; you can search specific data by selecting any title columns. By clicking the icons under <b>“Action”</b> column will allow you to update and delete. You can also open a data entry screen to input new Receipt Voucher’s Information by clicking the Menu tab <b>“New Receipt Voucher”</b>.  Also you can view the reports by clicking the icon of pdf or xls under the <b>”Reports”</b> column.
         </div>
</div>
	...
	'columns'=>array(
        ...
        array(
            ...
            (
                ...
                (
                    'label'=>'See Report',
                    'url'=>'Yii::app()->createUrl("../reports/receipt_voucher.php?pVoucherNo=$data->am_vouchernumber")',
                    'See Report',
