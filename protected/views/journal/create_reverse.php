...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        <b>New Reverse Entry </b>: In this screen, all of the required fields need to be filled before clicking the button <b>“Add New Voucher”</b>. Fields marked with (*) are mandatory. You can go back to your homescreen to view reverse entry information(s) by clicking the menu tab <b>“Manage Reverse Entry”</b>. Also you can add new voucher details on existing Voucher by clicking the link under <b> “Voucher Number” </b> column; this link will redirect you to voucher detail page. <b>Action</b> buttons will allow you to update and delete.
...
<div style="width: 98%; float: left;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <h1 style="background: #BA7F39; padding: 5px; width: 98%; font-weight: bold; text-align: center;">
            Reverse Entry Header Information
        </h1>
