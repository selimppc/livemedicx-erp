...
$this->breadcrumbs=array(
	'Journal Voucher'=>array('JournalVoucher'),
	'New Journal Voucher',
);

$this->menu=array(
	//array('label'=>'List Voucher Header', 'url'=>array('index')),
	array('label'=>'Manage Journal Voucher', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/manage_a.png" /></span>{menu}', 'url'=>array('JournalVoucher')),
...
?>
    ...
    <div id="flag_desc">
        ...
        <div id="flag_desc_text"> New Journal Voucher  </div>
    </div>
