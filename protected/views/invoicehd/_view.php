...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sm_storeid')); ?>:</b>
	<?php echo CHtml::encode($data->sm_storeid); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sm_chequeno')); ?>:</b>
	<?php echo CHtml::encode($data->sm_chequeno); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sm_currency')); ?>:</b>
	<?php echo CHtml::encode($data->sm_currency); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sm_exchrate')); ?>:</b>
	<?php echo CHtml::encode($data->sm_exchrate); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sm_note')); ?>:</b>
	<?php echo CHtml::encode($data->sm_note); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('glvoucher')); ?>:</b>
	<?php echo CHtml::encode($data->glvoucher); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('imvoucher')); ?>:</b>
	<?php echo CHtml::encode($data->imvoucher); ?>
	<br />
