...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'sm_note'); ?>
		<?php echo $form->textArea($model,'sm_note',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'imvoucher'); ?>
		<?php echo $form->textField($model,'imvoucher',array('size'=>50,'maxlength'=>50)); ?>
	</div>
