...
<div style="width: 100%; float: left;">
	<div style="width: 48%; float: left; padding-right: 1%;">
        ...
        <h1 style="background: #BA7C39; padding: 7px; width: 81%; font-weight: bold; text-align: center;">
	...
	<div style="width: 48%; float: left;">
        <h1 style="background: #BA7C39; padding: 7px; width: 96%; font-weight: bold; text-align: center;">
