...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        <label>Delevery To Warehouse </label>
        <?php //echo $form->dropDownList($model,'sm_storeid', CHtml::listData(Branchmaster::model()->findAll(array('order'=>'cm_branch ASC')), 'cm_branch', 'cm_description'), array('id'=>'warehouse', 'required'=>TRUE)); ?>
         <select id="warehouse" name="Purchaseordhd[pp_store]" required="required">
	...
	<div class="row">
		...
		<?php echo $form->hiddenField($model,'pp_discamt',array('class'=>'discamt', 'id'=>'discamt', 'readonly'=>true )); ?>
