...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <label>Discount Account Code</label>
        <?php echo $form->DropDownList($model,'cm_accdisc', CHtml::listData(Chartofaccounts::model()->findAll(array('order'=>'am_description ASC')), 'am_accountcode', 'am_description'), array('empty'=>'- Select Account -', 'required'=>TRUE) ); ?>
        <?php echo $form->error($model,'cm_accdisc'); ?>
    </div>
    ...
    <div class="row">
        <label>Sales/Vat Tax Account </label>
        <?php echo $form->DropDownList($model,'cm_acctax', CHtml::listData(Chartofaccounts::model()->findAll(array('order'=>'am_description ASC')), 'am_accountcode', 'am_description'), array('empty'=>'- Select Account -', 'required'=>TRUE) ); ?>
        <?php echo $form->error($model,'cm_acctax'); ?>
    </div>

    <div class="row">
        <label>Sales/Revenue Account </label>
        <?php echo $form->DropDownList($model,'cm_accdr', CHtml::listData(Chartofaccounts::model()->findAll(array('order'=>'am_description ASC')), 'am_accountcode', 'am_description'), array('empty'=>'- Select Account -', 'required'=>TRUE) ); ?>
        <?php echo $form->error($model,'cm_acctax'); ?>
    </div>
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter Customer Group' : 'Update Customer Group', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
