...
<?php $form=$this->beginWidget('CActiveForm', array(
   ...
   <!--  <div class="row">
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter Product Class' : 'Update Product Class', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
