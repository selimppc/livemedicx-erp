...
<div class="form">
    ...
    <!--div class="row">
        <label>Sales Return A/C </label>
        <?php //echo $form->DropDownList($model,'cm_accrtn', CHtml::listData(Chartofaccounts::model()->findAll(array('order'=>'am_description ASC')), 'am_accountcode', 'am_description'), array('empty'=>'- Select Account -', 'required'=>TRUE) ); ?>
        <?php //echo $form->error($model,'cm_accrtn'); ?>
    </div-->
    ...
    <div class="row">
        ...
        <?php echo $form->error($model,'cm_accdr'); ?>
    </div>
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter Product Category' : 'Update Product Category', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
