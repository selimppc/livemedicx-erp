...
<div class="form">
    ...
    <div class="row">
        ...
        $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
            ...
            'source'=>'js: function(request, response) {
                $.ajax({
                    url: "'.$this->createUrl('adjustdt/getProdNames').'",
                    dataType: "json",
                    data: {
                        term: request.term,
                    },
        ...
        $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
            ...
            'options'=>array(
                ...
                'select'=>'js:function(event, ui){
						...
						$("#unit").val(ui.item.unit);
                        $("#stock_rate").val(ui.item.rate);
                        $("#available_qty").val(ui.item.available);
					}'
            ),
            'htmlOptions'=>array(
                'id'=>'product_code',
        ...
        <p>&nbsp;</p>
        <br>
        <div id="productname" style="width: 50%; margin-left: 25%; padding: 5px; background: ghostwhite; font-weight: bold;"></div>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'unit', CHtml::listData(Codesparam::model()->findAll('cm_type="Unit Of Measurement"'), 'cm_code', 'cm_code'), array('id'=>'unit', 'empty'=>'- Select Unit -', 'required'=>TRUE,)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'quantity',array('id'=>'quantity', 'value'=>0, 'onchange'=>"getQuantity()")); ?>
    ...
    <script type="text/javascript">
        function getQuantity(){
            ...
            if(parseInt(qty) > parseInt(available_qty)){
                alert("Quantity is bigger than Available Quantity");
