...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note">Fields with <span class="required">*</span>Required Fields.</p>

	<?php // echo $form->errorSummary($model); ?>

	<div class="row">
		<?php echo $form->labelEx($model,'cm_branch'); ?>
		<?php echo $form->textField($model,'cm_branch',array('size'=>10,'maxlength'=>10, $model->isNewRecord ? '' : "readonly"=>True,'required'=>TRUE)); ?>
		<?php echo $form->error($model,'cm_branch'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'cm_description'); ?>
		<?php echo $form->textField($model,'cm_description',array('size'=>60,'maxlength'=>100,'required'=>TRUE)); ?>
   ...
   <!--  <div class="row">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'cm_contacperson',array('size'=>50,'maxlength'=>50,'required'=>TRUE)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'cm_mailingaddress',array('size'=>60,'maxlength'=>250,'required'=>TRUE)); ?>
		<?php echo $form->error($model,'cm_mailingaddress'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'cm_email'); ?>
		<?php echo $form->textField($model,'cm_email',array('size'=>20,'maxlength'=>50,'required'=>TRUE)); ?>
		<?php echo $form->error($model,'cm_email'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'cm_phone'); ?>
		<?php echo $form->textField($model,'cm_phone',array('size'=>20,'maxlength'=>20,'required'=>TRUE)); ?>
		<?php echo $form->error($model,'cm_phone'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'cm_cell'); ?>
		<?php echo $form->textField($model,'cm_cell',array('size'=>20,'maxlength'=>20)); ?>
		<?php echo $form->error($model,'cm_cell'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'cm_fax'); ?>
		<?php echo $form->textField($model,'cm_fax',array('size'=>20,'maxlength'=>20)); ?>
