...
<div id="flag_desc">
    ...
    <div id="flag_desc_text"> <b>Profit & Loss :</b> Select Year, Month, Branch and Report Type. To view report in pdf or xls click on <b>"PDF"</b> or <b>"XLS"</b> . *** Data Posting to GL is necessary for viewing and result. You can go back to the <b>Report Tools</b> to view all Report tools by clicking the menu tab  <b>“ << Back to Report”</b>.</div>
</div>

<div style="clear: both;"></div>

<?php echo CHtml::beginForm($this->createUrl('/reporttools/pnlReports'), 'POST', array('target'=>'_blank'))?>
