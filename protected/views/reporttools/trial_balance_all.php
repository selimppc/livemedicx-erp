...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        <b>Trial Balance All </b>: In this screen Branch and input desire dates, from and to, to report in pdf or xls click <b>PDF</b> or <b>XLS</b> respectively. *** Data Posting to GL is necessary for viewing and result. You can go back to the Report Tools to view all Report tools by clicking the menu tab <b>“<< Back to Report”</b>.
...
<div>
<?php echo CHtml::beginForm($this->createUrl('/reporttools/TrialBalanceAllReport'), 'POST', array('target'=>'_blank'))?>
