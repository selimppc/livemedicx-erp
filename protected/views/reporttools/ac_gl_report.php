...
<table style="text-align: left; ">
	  ...
	  <tr>
		...
		<td> <?php echo CHtml::activeDropDownList($coa, 'am_description', CHtml::listData(Chartofaccounts::model()->findAllByAttributes(array('am_analyticalcode' => 'Cash')), 'am_accountcode', 'am_description'), array('empty'=>'- Select Chart of A/C -')); ?> </td>
