...
$cus=$_GET['cm_code'];
						   ...
						   $conn=mysqli_connect('localhost','root','','ur2');
						   
										
										$sql="select * from sm_vw_mrrcv";
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'focus'=>array($model,'cm_cuscode','sm_invnumber'),
)); ?>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(".items tr").click(function() {
			...
			//var sm_date=document.getElementById("sm_date");
			//return sm_date;
...
<table class="money-receipt-sales">
	...
	<tr> 
		...
		<td> Date:(yy-mm-dd) &nbsp;&nbsp;</td> 
		<td><?php echo $form->textField($model,'sm_date', array('id'=>'sm_date','style'=>'width: 120px;')); ?>
		<?php //echo $form->textField($model,'sm_date', array('id'=>'sm_date', 'readonly'=>'readonly', 'style'=>'width: 120px;')); ?>
					...
					<tbody class="items">
						<?php  foreach($mralc as $values): { ?>
							<tr style="background: white;">
								...
								<td style="text-align: right"><?php echo $values['sm_date']?>
								<?php $date=$values['sm_date'];?>
								</td>
							</tr>
