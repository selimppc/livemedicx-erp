...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        <b>Branch List Report </b>: In this screen select Branch, Supplier and input desire dates, from and to, to report in pdf or xls click <b>PDF</b> or <b>XLS</b> respectively. *** Data Posting to GL is necessary for viewing and result. You can go back to the Report Tools to view all Report tools by clicking the menu tab <b>“<< Back to Report”</b>.
</div>
</div>
<div style="clear: both"></div>
<br>

<form action="../../reports/branch_list_report.php" target="_blank">
