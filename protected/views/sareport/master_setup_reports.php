...
<div style="width: 98%; margin: 0 auto;">
	...
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Customer Ledger Report',array('sareport/customerLedger')); ?>
		</div>
	</div>
    <div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Customer List Report',array('sareport/customerListReport')); ?>
		</div>
	</div>
		<div id="report_main_div">
			<div id="report_button">
				<?php echo CHtml::link('Expired Product List',array('sareport/EproductList')); ?>
			
		</div>
	</div>
    <div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Supplier List Report',array('sareport/SupplierReport')); ?>
		</div>
	</div>
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Supplier Ledger Report',array('sareport/SupllierLedger')); ?>
		</div>
	</div>

     <div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Branch List Report',array('sareport/Branchlistreport')); ?>
		</div>	
	</div>
