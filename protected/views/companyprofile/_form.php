...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'shortdescription',array('required'=>TRUE, 'rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'shortdescription'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'longdescription'); ?>
		<?php echo $form->textArea($model,'longdescription',array('required'=>TRUE, 'rows'=>6, 'cols'=>50)); ?>
