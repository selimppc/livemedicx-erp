...
<div style="width: 98%; float: left;" >
    ...
    <div style="width: 46%; float: left;" >
        ...
        <h1 style="background: #BA7F39; padding: 7px; width: 85%; text-align: center; font-weight: bold;">
    ...
    <div style="width: 54%; float: left; line-height: 8px;" >
        ...
        <h1 style="background: #BA7F39; padding: 13px; width: 95%; text-align: center; font-weight: bold;">
                    ...
                    (
                        ...
                        (
                            ...
                            (
                                ...
                                'options'=>array('id'=>'delete-button'),
                            ),
