...
$this->breadcrumbs=array(
	'Payment Voucher'=>array('PaymentVoucher'),
	'New Payment Voucher',
);

$this->menu=array(
	//array('label'=>'List Voucher Header', 'url'=>array('index')),
	array('label'=>'Manage Payment Voucher', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/manage_a.png" /></span>{menu}', 'url'=>array('PaymentVoucher')),
...
?>
    ...
    <div id="flag_desc">
        ...
        <div id="flag_desc_text"> New Payment Voucher </div>
    </div>
