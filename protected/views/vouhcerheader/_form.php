...
$(document).ready(function(){
	$("#button_add").click(function() {
        ...
        var am_description = e.options[e.selectedIndex].label;
...
function getMe(){
	...
	function Required(){
			var total_prime_amount = document.getElementById("total_prime_amount").value;
			var total_base_amount = document.getElementById("total_base_amount").value;
			
			if(total_prime_amount !="0" || total_base_amount !="0"){
					alert("WARNING Report: The journal must balance ie debits equal to credits before it can be processed ");
					return false;
			}else{
				return true;
			}
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note">Fields with <span class="required">(*)</span> required.</p>
...
<table>
	...
	<tr>
		...
		<td colspan="2"> 
				<?php echo $form->textField($model,'am_vouchernumber', array('id'=>'am_vouchernumber', 'style'=>'width: 140px;', 'readonly'=>'readonly') ); ?> 
				<?php echo $form->error($model,'am_vouchernumber'); ?></td>
		<td> Date </td>
		<td colspan="2"> 
...
<table>	
	...
	<tbody>
		<tr>
			...
			<td width="114"> <input id="currency_a" style="width: 114px; padding: 3px;" /> </td>
			<td width="114"> <input id="exchange_rate" style="width: 114px; padding: 3px;" /> </td>
...
<table style="width: 34%; float: left; margin-left: 46%;">
	<tr>
		...
		<td width="120"> <?php echo $form->textField($model,'am_referance1', array('value'=>'0', 'id'=>'total_base_amount', 'readonly'=>'readonly',  'style'=>'width: 120px; text-align: right')); ?> </td>
			...
			<?php echo CHtml::submitButton($model->isNewRecord ? 'Save' : 'Save', array('class'=>'action-btn', 'id'=>'action-btn-1', 'onclick'=>'return Required()' ) ); ?>
