...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'urlExpression'=>'array("../reports/addvoucher.php?pVoucherNo=$data->voucherno")',
        ...
        array(
            ...
            (
                ...
                (
                    'label'=>'See Report',
                    'url'=>'Yii::app()->createUrl("../reports/stockadjust_report.php?ptrnnumber=$data->transaction_number")',
                    'See Report',
