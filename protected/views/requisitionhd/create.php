...
<div style="width: 98%; float: left;">
    <div style="width: 46%; float:left; margin-right: 3%;">
        ...
        <h1 style="background: #BA7C39; padding: 7px; width: 86%;font-weight: bold; text-align: center;">
    ...
    <div style="width: 51%; float: left;">
        ...
        <h1 style="background: #BA7C39; padding: 7px; width: 97%;font-weight: bold; text-align: center;">
