...
<div style="width: 98%; float: left;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <div>
            <div style="width: 98%; float: left; text-align: right; background: #BA7F39; font-weight: bold; padding: 5px;">
        ...
        <div style="width: 99%; float: left; text-align: center;">
            <?php echo CHtml::link('POST to GL', array('PostToGlRv', 'am_vouchernumber'=>$am_vouchernumber), array('class'=>'btn_btn', 'id'=>'togglee', 'style'=>'height: 21px; text-align: center; width: 143px;  box-shadow: 10px 3px 5px #aaa;  ')); ?>
               ...
               <div id="report_icon_apel">
                <a href="../../reports/reverse_entry.php<?php echo '?pVoucherNo='.$am_vouchernumber?>" class="apel" target="_blank">See Report</a>
            <!-- </div>
                <div id="report_icon">
                <a href="../../reports/reverse_entry.php<?php //echo '?pVoucherNo='.$am_vouchernumber?>" class="action-btn" target="_blank">See Report</a>
            </div> -->
