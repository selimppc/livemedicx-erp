...
$this->breadcrumbs=array(
    'General Ledger',
	'Journal Voucher'=>array('journal/admin'),
	'New Voucher Detail',
);

$this->menu=array(
	array('label'=>'<< Go Back to Header', 'url'=>array('journal/create')),
);
?>
...
<div style="width: 98%; float: left;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <h1 style="background: #BA7F39; padding: 5px; width: 98%; font-weight: bold; text-align: center;">
            Voucher Header # <span style="color: blue;"> <?php echo $am_vouchernumber; ?></span> with Details
        </h1>
            ...
            'columns'=>array(
                ...
                array(
                    ...
                    (
                        ...
                        (
                            'label'=>'update',
                            'url'=>'Yii::app()->createUrl("journaldt/update/",
        ...
        <div style="width: 99%; float: left; text-align: center;">
            ...
            <div id="report_icon_apel">
                <a href="../../reports/journal_voucher.php<?php echo '?pVoucherNo='.$am_vouchernumber?>" class="apel" target="_blank">See Report</a>
            </div>
