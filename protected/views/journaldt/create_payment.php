...
$this->breadcrumbs=array(
    'General Ledger',
	'Payment Voucher'=>array('journal/adminPayment'),
	'New Payment Voucher Detail',
);

$this->menu=array(
	array('label'=>'<< Go Back to Header', 'url'=>array('journal/createPayment')),
);
?>
...
<div style="width: 98%; float: left;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <h1 style="background: #BA7F39; padding: 5px; width: 98%; font-weight: bold; text-align: center;">
            Payment Voucher # <span style="color: blue;"> <?php echo $am_vouchernumber; ?></span> with Details
        </h1>
            ...
            'columns'=>array(
                ...
                array(
                    ...
                    (
                        ...
                        (
                            'label'=>'update',
                            'url'=>'Yii::app()->createUrl("journaldt/updatePayment/",
        ...
        <div>
            <div style="width: 98%; float: left; text-align: right; background: #ccc; font-weight: bold; padding: 5px;">
                   ...
                   <!--  <div style="width: 26%; float: left;" id="prime-amt"><?php //echo $primeamt; ?></div> -->
                    <div style="width: 45%; float: left;" id="base-amt"><?php echo $baseamt; ?></div>
            </div>
        </div>
        ...
        <div style="width: 99%; float: left; text-align: center;">
            ...
            <?php echo CHtml::link('POST to GL', array('PostToGlAp', 'am_vouchernumber'=>$am_vouchernumber), array('class'=>'btn_btn', 'id'=>'togglee', 'style'=>'height: 21px; text-align: center; width: 143px; box-shadow: 10px 3px 5px #aaa; ')); ?>

             <div id="report_icon_apel">
                <a href="../../reports/payment_voucher.php<?php echo '?pVoucherNo='.$am_vouchernumber?>" class="apel" target="_blank">See Report</a>
            </div>

            <!--  <div id="report_icon">
                <a href="../../reports/payment_voucher.php<?php //echo '?pVoucherNo='.$am_vouchernumber?>" class="action-btn" target="_blank">See Report</a>
            </div> -->
    ...
    $(document).ready(function(){
        $(function(){
            ...
            if( base_amt>0 || base_amt < 0 ){
                $("#notice_amt").text("WARNING: To balance journal entry(s). Local Debits and Credits for any transaction must always equal each other.").css('color', 'red');
