...
class Chartofaccounts extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('am_accountcode',$this->am_accountcode,true,'OR');
		$criteria->compare('am_description',$this->am_description,true,'OR');
    ...
    public function searchNew()
    {
       ...
       $criteria->order = "am_accountcode ASC";
