...
class Transaction extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cm_type, cm_trncode,cm_branch', 'required'),
	...
	public function search()
	{
		...
		$criteria->compare('cm_lastnumber',$this->cm_lastnumber,true);
		$criteria->compare('cm_increment',$this->cm_increment,true);
		$criteria->compare('cm_active',$this->cm_active,true);
