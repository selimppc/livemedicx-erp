...
class Branchmaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cm_branch,cm_description,cm_mailingaddress,cm_phone,cm_email,cm_contacperson', 'required'),
			// array('cm_description', 'required'),
			// array('cm_mailingaddress',  'required'),
			array('active', 'numerical', 'integerOnly'=>true),
			array('cm_branch, cm_fax', 'length', 'max'=>10),
			array('cm_phone, cm_cell', 'length', 'max'=>20),
			array('cm_description', 'length', 'max'=>100),
			array('cm_email', 'length', 'max'=>50),
			...
			array('cm_branch, cm_description, cm_currency, cm_exchrate, cm_contacperson, cm_designation, cm_mailingaddress,cm_email, cm_phone, cm_cell, cm_fax, active, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
		);
	}
