...
<head>
	...
	<style type="text/css">
		body{
		width: 100%;
			background:url('/../../glis/images/bg_home.jpg') no-repeat fixed;
		}
...
<div id="main-wrapper">
    <header class="header" id="top-header">
        ...
        <div style="margin-top: 1%; text-align: right; margin-right: 7%;">
            <a href="<?php echo substr(Yii::app()->baseUrl, 0, -3); ?>" class="myButton">EN</a>
            <a href="<?php echo Yii::app()->baseUrl; ?>" class="myButton">FR</a>
        </div>
    ...
    <div id="homepage_div">
        <div id="homepage_content">
            <div id="homepage_title">
                <h2 style="color: #2A4786; font-size: 23px;">ERP & Supply Chain Management</h2>
            </div>
            
            <div id="homepage_dashboard">
                <h1>Your iTabps ERP is...</h1>
            </div>
            
            <div class="homepage_text_div">
                <p class="home_text_gray" style="color: #008000; font-size: 15px; ">
                    <b>Industry-specific ERP solutions for agile, flexible and tightly integrated</b>
                    <p style="width: 75%; color: #008000; font-size: 15px; text-align: center;"> <b> operations! </b></p>
                </p>
        ...
        <div id="homepage_login">
            <div id="user_login_div">
                <h3 style="color: orange; font-size: 25px;">USER LOGIN</h3>
            </div>
