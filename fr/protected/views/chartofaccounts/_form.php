...
<table style="width: 99%; float: left;">
	<tr> 
		<td colspan="2" style="text-align: center; background: #4085BB; color: white;"> Liste des comptes  </td>
	</tr>
	<tr>
		<td width="140">code du compte <span class="required">*</span></td>
	...
	<tr>	
		<td> Description du compte <span class="required">*</span></td>
	...
	<tr>
		...
		<td class="compactRadioGroup"> 
			...
			<?php echo  $form->radioButtonList($model,'am_accounttype',array('Asset'=>'Actif','Liability'=>'passif', 'Income'=>'revenu', 'Expenses'=>'dépenses'), array('separator'=>'', 'labelOptions'=>array('style'=>'display:inline; margin: -5px 25px 0px 0px; padding: 0px 0px 0px 3px; '), 'required'=>TRUE)); ?>
		</td>
		
	</tr>
	<tr>
		<td> Utilisation du compte </td>
		<td class="compactRadioGroup"> <?php //echo $form->radioButtonList($model,'am_accountusage',array('Ledger'=>'Ledger','AP'=>'AP', 'AR'=>'AR')); ?> 
		<?php echo  $form->radioButtonList($model,'am_accountusage',array('Ledger'=>'Livre des comptes','AP'=>'AP', 'AR'=>'AR'), array('separator'=>'', 'labelOptions'=>array('style'=>'display:inline; margin: -5px 25px 0px 0px; padding: 0px 0px 0px 3px;'), 'required'=>TRUE)); ?>
	...
	<tr>
		...
		<td> <?php 
				...
				echo $form->DropDownList($model,'am_groupone',$groupone,
					array(
                        'prompt'=>'- Selectionner le premier Groupe -',
                        'ajax'=>array(
	...
	<tr>
		<td>Deuxièmegroupe </td>
        <td> <?php $grouptwo = CHtml::listData(Grouptwo::model()->findAll(),'am_grouptwo','am_description');
            echo $form->dropDownList($model,'am_grouptwo', $model->isNewRecord ? array() : $grouptwo, array('empty'=>'- Selectionner le second Groupe -')); ?> </td>
	...
	<tr>	
		...
		<?php echo $form->radioButtonList($model,'am_status',array('Open'=>'Ouvert','Close'=>'fermé'), array('separator'=>'', 'labelOptions'=>array('style'=>'display:inline; margin: -5px 25px 0px 0px; padding: 0px 0px 0px 3px;'), 'required'=>TRUE)); ?>
		</td>
	</tr>
