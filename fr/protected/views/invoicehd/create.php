...
?>
    ...
    <div id="flag_desc">
        ...
        <div id="flag_desc_text"><b>hghg New Invoice:</b> In this screen fill up the fields in both tables. Please follow the <b style="color: #008000;">Instruction</b> below ** on column <b>Item Details</b>.</div>
    </div>
...
<div style="width: 98%; float: left;">
    <div style="width: 46%; float:left; margin-right: 3%;">
        ...
        <h1 style="background: #d3d3d3; padding: 7px; width: 86%;font-weight: bold; text-align: center;">
            Entrer les informations sur l'en-tête de la facture
        </h1>
