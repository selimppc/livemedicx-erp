...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        <b>Rapporter</b>: Sur cet écran vous avez le choix de voir le Module de Rapport d'une commande .
         </div>
</div>
...
<div style="width: 98%; margin: 0 auto;">
	...
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link("Rapport d'une commande d'Achat",array('sareport/purchaseOrdRepo')); ?>
		</div>	
	</div>
	<!--
	<div id="report_main_div"> 
