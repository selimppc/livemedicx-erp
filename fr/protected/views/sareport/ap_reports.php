...
<div id="flag_desc">
    ...
    <div id="flag_desc_text"> <b>Outils de reportage des Comptes à payer</b>: sur cet écran vous avez l'accès aux rapports des comptes à payer.</div>
</div>
...
<div style="width: 98%; margin: 0 auto;">
	...
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Livre des fournisseur',array('sareport/SupllierLedger')); ?>
		</div>	
	</div>
	<!-- 
	<div id="report_main_div"> 
