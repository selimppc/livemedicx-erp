...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">sur cet écran, vous avez l'accès  & vue aux reportages des configurations de contrôle.</div>
</div>
...
<div style="width: 98%; margin: 0 auto;">
	...
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Raportage de la Liste des Produits',array('sareport/productList')); ?>
		</div>	
	</div>
	...
	<div id="report_main_div"> 
		<div id="report_button">
			<?php echo CHtml::link('Reportage du Livre des clients',array('sareport/customerLedger')); ?>
		</div>
	</div>
    <!--
	<div id="report_main_div"> 
