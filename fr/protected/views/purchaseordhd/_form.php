...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <?php echo $form->dropDownlist($model,'cm_supplierid', CHtml::listData(Suppliermaster::model()->findAll(), 'cm_supplierid', 'cm_orgname'), array('empty'=>'- Séléctionner un fournisseur -', 'required'=> TRUE)); ?>
	...
	<div class="row">
		...
		<?php  echo $form->dropDownlist($model,'pp_store', CHtml::listData(Branchmaster::model()->findAll(), 'cm_branch', 'cm_description'), array('empty'=>'- Séléctionner un entrepôt -', 'required'=>true, ) ); ?>
	...
	<div class="row">
        ...
        <?php $currency= CHtml::listData(Currency::model()->findAll('cm_active = 1'), 'cm_currency', 'cm_description');
              echo $form->dropDownList($model,'pp_currency', $currency, array('empty'=>'- Séléctionner le Devise -','required'=>TRUE,
