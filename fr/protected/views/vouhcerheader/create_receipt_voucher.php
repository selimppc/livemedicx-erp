...
$this->breadcrumbs=array(
	'Receipt Voucher'=>array('ReceiptVoucher'),
	'New Receipt Voucher',
);

$this->menu=array(
	//array('label'=>'List Voucher Header', 'url'=>array('index')),
	array('label'=>'Manage Receipt Voucher', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/manage_a.png" /></span>{menu}', 'url'=>array('ReceiptVoucher')),
...
?>
    ...
    <div id="flag_desc">
        ...
        <div id="flag_desc_text"> New Receipt Voucher </div>
    </div>
