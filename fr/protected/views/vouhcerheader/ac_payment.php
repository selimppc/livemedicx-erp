...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">
        Sur cet écran, vous serez en mesure de voir l'historique à  payer après Comptes à payer.  Vous pouvez également consulter le rapport détaillé en cliquant sur le lien sous le numéro du coupon.
    </div>
</div>
