...
$this->breadcrumbs=array(
	...
	'Manage Payment Voucher',
);

$this->menu=array(
	//array('label'=>'List Voucher Header', 'url'=>array('index')),
	array('label'=>'New Payment Voucher', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/create_a.png" /></span>{menu}', 'url'=>array('PaymentVoucherCreate')),
...
<div id="flag_desc">
    ...
    <div id="flag_desc_text"> Manage Payment Voucher </div>
</div>
