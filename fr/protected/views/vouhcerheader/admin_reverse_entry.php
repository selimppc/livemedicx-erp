...
$this->breadcrumbs=array(
	...
	'Manage Reverse Entry',
);

$this->menu=array(
	//array('label'=>'List Voucher Header', 'url'=>array('index')),
	array('label'=>'New Reverse Entry', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/create_a.png" /></span>{menu}', 'url'=>array('ReverseEntryCreate')),
...
<div id="flag_desc">
    ...
    <div id="flag_desc_text"> Manage Reverse Entry </div>
</div>
