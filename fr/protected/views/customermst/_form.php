...
<div class="form" style="width: 100%; float: left;">
    ...
    <div id="box_input_id">
        ...
        <div id="part_20">
            ...
            <?php echo $form->textField($model,'country_code', array('readonly'=>TRUE)); ?>
        </div>
        ...
        <div id="part_20">
            ...
            <label><span style="color: red;">Selectionner le District *</span> </label>
    ...
    <div id="box_input_id">
        ...
        <div id="part_40" class="compactRadioGroup">
            ...
            <?php echo $form->radioButtonList($model,'c_status', array('Open'=>'Ouvert','Close'=>'Fermé'),
