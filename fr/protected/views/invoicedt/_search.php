...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'sm_unit',array('size'=>50,'maxlength'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'sm_lineamt'); ?>
		<?php echo $form->textField($model,'sm_lineamt',array('size'=>20,'maxlength'=>20)); ?>
	</div>
