...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'cm_supplierid', CHtml::listData(Suppliermaster::model()->findAll(),'cm_supplierid','cm_orgname'),array('empty'=>"- séléctionner l'Identité du fournisseur -", 'required'=> TRUE )); ?>
    ...
    <div class="row">
        ...
        echo $form->dropDownList($model,'pp_currency', $currency, array('empty'=>'- Choisir le Devise -',
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'pp_branch', CHtml::listData(Branchmaster::model()->findAll(),'cm_branch','cm_description'),array('empty'=>'- séléctionner  une branche -', 'required'=> TRUE)); ?>
