...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter IM Transaction No' : 'Update Transaction No', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
