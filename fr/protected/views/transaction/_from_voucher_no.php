...
<h1 style="background: #FFCCFF; padding: 5px; width: 87%; font-weight: bold; text-align: center">
    Enter Voucher No Information
</h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter Voucher No' : 'Update Voucher No', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
