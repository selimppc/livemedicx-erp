...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">Nouvelle transanction  de la gestion des approvisionnements :: Vous pouvez configurer le numéro de transanction de  la gestion des approvisionnements .
    </div>
</div>
