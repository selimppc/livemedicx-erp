...
$this->menu=array(
    ...
    /*array('label'=>'Manage BRNumber', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/manage_a.png" /></span>{menu}', 'url'=>array('transaction/ManageGRNnumnber')),
...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">Numéro du nouveau BR </div>
</div>
