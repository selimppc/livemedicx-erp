...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Money Receipt No' : 'Update Money Receipt', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
