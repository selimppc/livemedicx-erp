...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Enter Adjustment Number' : 'Update Adjustment Number', array('class'=>'btn_btn', 'name' => 'submit', 'style'=>'width: 200px; margin-left: 200px;')); ?>
    </div>
