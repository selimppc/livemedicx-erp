...
<div style="width:99%; float: left;">
	...
	<table>
		...
		<tr>
            ...
            <td> <?php echo $form->dropDownList($model,'sm_payterms', array('Cash'=>'Payé Cash','Credit'=>'Crédit'), array('id'=>'sm_payterms')); ?> </td>
			<!-- <td>
		...
		<tr>
			...
			<td>
                ...
                echo $form->dropDownList($model,'sm_currency', $currency, array('empty'=>'- Le taux de Devise -', 'required'=>TRUE,
		...
		<tr>
			<td> Vente en provenace de l'Entrepôt    <?php //echo $form->labelEx($model,'sm_storeid'); ?> </td>
    ...
    <p style="color: darkorange; padding: 5px; font-weight: bold;">Ecrivez votre montant total et la TVA en dessous.</p>
    <table>
        <tr>
            <td>
                <b>Montant (Excel TVA)</b>
            </td>
            <td>
