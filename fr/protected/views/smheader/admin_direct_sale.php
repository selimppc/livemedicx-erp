...
$this->menu=array(
    array('label'=>'Nouvelle vente directe', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/create_a.png" /></span>{menu}', 'url'=>array('smheader/directSale')),
	...
	'columns'=>array(
        ...
        array(
            ...
            (
                ...
                (
                    'label'=>'toPDF',
                    'url'=>'Yii::app()->createUrl("sareport/directSale/", array("psmnumber"=>$data->sm_number) )',
                ...
                (
                    'label'=>'toExcel',
                    'url'=>'Yii::app()->createUrl("sareport/directSales/", array("psmnumber"=>$data->sm_number) )',
