...
$this->menu=array(
	...
	array('label'=>'Manage BRDetail', 'template'=>'<span><img src="'.Yii::app()->baseUrl.'/images/manage_a.png" /></span>{menu}', 'url'=>array('admin')),
);
?>
...
<div id="flag_desc">
    ...
    <div id="flag_desc_text">Update GRN Detail</div>
</div>
