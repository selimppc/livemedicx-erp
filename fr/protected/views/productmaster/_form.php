...
<div style="float: left; width: 50%;">
    ...
    <div class="row">
        ...
        <span style="color: #FF6600; float: left; margin-bottom: 5px;">
			<?php echo $model->isNewRecord ? ' Le Code du Produit doit être unique' : 'Le Code du Product  ne peut pas être changed '?>
		</span>
    ...
    <div class="row"> <!--AMIT. HERE I SWITCH GROUP DOWN CATEGORY UP-->
        ...
        <?php echo $form->dropDownList($model,'cm_category', CHtml::listData(Codesparam::model()->findAll('cm_type="Product Category"'), 'cm_code', 'cm_code'), array('empty'=>'- Selectionner la Categorie du  Produit -', 'required'=>TRUE,)); ?>
        <?php echo $form->error($model,'cm_category'); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($model,'cm_group'); ?>
        <?php echo $form->dropDownList($model,'cm_group', CHtml::listData(Codesparam::model()->findAll('cm_type="Product Group"'), 'cm_code', 'cm_code'), array('empty'=>'- Selectionner le  Groupe du Produit -', 'required'=>TRUE,)); ?>
    ...
    <div class="row">
        ...
        echo $form->dropDownList($model,'currency', $currency, array('empty'=>'- Selection du Devise -', 'required'=>TRUE,
...
<div style="float: left; width: 50%;">
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'cm_purunit', CHtml::listData(Codesparam::model()->findAll('cm_type="Unit Of Measurement"'), 'cm_code', 'cm_code'), array('empty'=>"- Selectionner l'Unité d'Achat -", 'required'=>TRUE,)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'cm_stkunit', CHtml::listData(Codesparam::model()->findAll('cm_type="Unit Of Measurement"'), 'cm_code', 'cm_code'), array('empty'=>"- Selectionner l'Unité d'Achat - ", 'required'=>TRUE,)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'cm_stocktype', (array('Stock N Sell'=>'Vente du Stock N','Non Stock'=>'sans Stock'))); ?>
