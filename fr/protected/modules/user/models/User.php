...
class User extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            'id' => UserModule::t("Id"),
            'username'=>UserModule::t(" Nom de l'utilisateur"),
            'password'=>UserModule::t("Mot de passe "),
            'verifyPassword'=>UserModule::t("Retype Mot de passe "),
            'email'=>UserModule::t("E-mail"),
            'repeatpassword'=>UserModule::t("Retype Password"),
            'employeeid'=>UserModule::t("Employee Id"),
            'employeebranch'=>UserModule::t("Branche de l'employé"),
            'user_type'=>UserModule::t("Type d'utilisateur"),

            'verifyCode'=>UserModule::t("Verification Code"),
            'activkey' => UserModule::t("activation key"),
            'createtime' => UserModule::t("Date d'enregistrement"),
            'create_at' => UserModule::t("Date d'enregistrement"),
            'lastvisit_at' => UserModule::t("Dernière visite"),
