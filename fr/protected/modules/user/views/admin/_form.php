<div class="form" >
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'employeebranch', CHtml::listData(Branchmaster::model()->findAll(), 'cm_branch', 'cm_branch'), array('empty'=>'- Selectionner la branche -', 'required'=>TRUE,) ); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'user_type',array(
            'Admin'=> Yii::t('app', 'Administrateur'),
            'Country Director + Finance'=>'Directeur National + Financement',
            'General Ledger'=>'General Ledger',
            'GL and Inventory'=>'GL and Inventaire',
            'Inventory'=>'Inventaire',
            'Inventory Without Stock Adjustment'=>'Inventaire Sans Stock Ajustement',
            'Managers'=>'Gestionnaires',
            'Purchase'=>'Achat',
            'Purchase and Inventory'=>'Achat and Inventaire',
            'Regional Director'=>'Directeur régional',
            'Sales'=>'Ventes',
            'Sales and Inventory'=>'Ventes and Inventaire',
            'Sales, Purchase and Inventory'=>'Ventes, Achat and Inventaire',
            'Sales, Purchase, Inventory and GL'=>'Ventes, Achat, Inventaire and GL',
        ), array('empty'=>"- Selectionner le type d'utilisateur -", 'required'=>TRUE )); ?>
