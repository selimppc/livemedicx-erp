...
class Smheader extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('sm_date, inserttime, updatetime, sm_currency, sm_exchrate, sm_note, imvoucher', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'sm_date' => 'Date des ventes',
			'cm_cuscode' => 'Code Client',
			'sm_sp' => 'Personne de Ventes',
			'sm_doc_type' => 'Doc Type',
			'sm_storeid' => 'Store ID',
			'sm_territory' => 'Territory',
			'sm_rsm' => 'Rsm',
			'sm_area' => 'Area',
			'sm_payterms' => 'Termes de paiement',
			'am_accountcode' => 'Accountcode',
			'sm_chequeno' => 'Cheque No',
            'sm_currency' => 'Le change',
            'sm_exchrate' => 'Taux de devise',
            'sm_note' => 'Note',
			'sm_totalamt' => 'Montant Total',
			'sm_total_tax_amt' => 'montant totaldu taxe',
			'sm_disc_rate' => 'Taux de réduction (%)',
			'sm_disc_amt' => 'Montant réduit',
