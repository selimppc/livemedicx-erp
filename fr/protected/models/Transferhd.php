...
class Transferhd extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'im_transfernum' => 'Numéro du transfert',
			'im_date' => 'Date de livraison du transfert',
			'im_condate' => 'Date de confirmation du transfert',
			'im_note' => 'Note',
			'im_fromstore' => 'En provenance du stock',
            'im_fcur'=> 'Le change à partir du magasin',
            'im_fexchrate'=>'Exchage Rate from Store',
			'im_tostore' => 'Au Magasin',
            'im_tcur'=> 'Le change du transfert',
         	'im_texchrate' => 'Transfer Exchange Rate',
			'im_status' => 'Statut du transfert',
