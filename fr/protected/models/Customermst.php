...
class Customermst extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cm_cuscode, cm_name, cm_address, cm_territory, cm_group,c_type, cm_cellnumber, cm_phone, cm_fax, cm_email, cm_branch, cm_market, cm_sp, cm_creditlimit, cm_hub,c_status, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'cm_cuscode' => ' Code du Client',
			'cm_name' => 'Nom du client',
			'cm_address' => 'Adresse',
			'cm_territory' => 'Territory',
			'cm_group' => ' Groupe du Client',
			'c_type'=>'Type de Client',
	
			'cm_cellnumber' => 'Mobile/Cellulaire',
			'cm_phone' => 'Téléphone',
			'cm_fax' => 'Fax',
			'cm_email' => 'Email',
			'cm_branch' => 'Branche',
			'cm_market' => 'Area',
			'cm_sp' => 'Vendeur',
			'cm_creditlimit' => ' Limite du Crédit',
			'cm_hub' => 'Hub',
			'c_status'=> 'Status',
