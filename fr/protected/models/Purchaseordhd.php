...
class Purchaseordhd extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'pp_purordnum' => 'Numéro du bon de commande',
			'pp_date' => 'Date',
			'cm_supplierid' => 'Identité du fournisseur',
			'pp_requisitionno' => 'Requisition Number',
			'pp_payterms' => 'Termes de paiement',
			'pp_deliverydate' => 'Date de livraison',
			'pp_store' => 'Entrepôt distributeur',
			'pp_taxrate' => 'Tax Rate ( % )',
			'pp_taxamt' => 'Tax Amount',
			'pp_discrate' => 'Taux de reduction ( % )',
			'pp_discamt' => 'Discount Amount',
			'pp_amount' => 'Montant total',
            'pp_netamt'=>'Net Amount',
			'pp_status' => 'Status',
			'pp_currency' => 'Change',
            'pp_exchrate'=>'Taux de devise',
