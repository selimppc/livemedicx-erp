...
class VwStock extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'cm_name' => 'Nomdu produit',
			'im_BatchNumber' => 'Numéro du paquet',
			'im_ExpireDate' => 'Date de péremption',
			'im_storeid' => 'Entrepôt',
			'im_rate' => 'Taux de stockage',
			'im_unit' => 'Unité',
			'issueqty' => 'Quantité du transfert',
			'saleqty' => 'Quantité Vendue',
			'inhandqty' => 'Quantité en stock',
