...
class Grnheader extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'im_grnnumber' => 'Numéro du GRN',
			'im_purordnum' => "Numéro de la demmande d'Achat",
			'am_vouchernumber' => 'Numéro du CouponGL',
			'im_date' => 'Date',
			'cm_supplierid' => 'Nom du Fournisseur',
			'pp_requisitionno' => 'Requisition Num',
			'im_payterms' => 'Termes de paiement',
			'im_store' => 'Store',
			'im_taxrate' => 'Tax Rate',
			'im_taxamt' => 'TVA',
			'im_discrate' => 'Discount Rate',
			'im_discamt' => 'Discount Amount',
			'im_currency' => 'Le  Change',
			'im_amount' => 'Montant',
			'im_netamt' => 'Montant Net',
			'im_status' => 'Status',
			'inserttime' => 'Inserttime',
			'updatetime' => 'Updatetime',
			'insertuser' => 'Insertuser',
			'updateuser' => 'Updateuser',
			'cm_orgname' => 'Description du fournisseur',
            'supplier_search' => 'Nom du Fournisseur',
		);
	}
