...
class Productmaster extends CActiveRecord
{
    ...
    */
	...
	{
		return array(
			'cm_code' => 'Code du Produit',
			'cm_name' => 'Nom du produit',
			'cm_description' => 'Description',
			'image' => 'Image',
			'cm_class' => 'Classe',
			'cm_group' => 'Groupe',
			'cm_category' => 'Catégorie',
			'currency' => 'Le change',
            'exchange_rate'=>'Taux de devise',
			'cm_sellrate' => 'Taux de vente',
			'cm_costprice' => 'Le prix',
			'cm_sellunit' => 'Unité de vente',
			'cm_sellconfact' => 'Quantité Unitaire de vente',
			'cm_purunit' => "Unité d'Achat",
			'cm_purconfact' => "Quantité Unitaire d'Achat",
			'cm_stkunit' => 'Unité de Stock',
			'cm_stkconfac' => 'Quantité Unitaire du Stock',
			'cm_packsize' => "imension d'un paquet",
			'cm_stocktype' => 'Type de Stock ',
			'cm_generic' => 'Générique',
			'cm_supplierid' => " Identité d'identité",
			'cm_mfgcode' => 'Code du MGF',
			'cm_maxlevel' => 'Max Level',
			'cm_minlevel' => 'Niveau Ministériel',
			'cm_reorder' => 'Re-order',
